...
class NoteBook(UserList):
    ...
    def edit(self, name):
        for it in self.data:
            if str(it.name) == name.title():
                while True:
                    comm_list = WordCompleter(
                        ["Name", "Tags", "Note"], ignore_case=True
                    )
                    value = prompt(
                        "    > Choose what to edit. Name/Tags/Note: ",
                        completer=comm_list,
        ...
        while True:
            ...
            if len(self.inp.replace(" ", "")) > 20:
                print(
                    Fore.WHITE
                    + Back.RED
                    + "  > The title is too long......... Must be less than 20."
                )
            elif self.inp == "":
        ...
        while True:
            ...
            if len(self.inp.replace(" ", "")) < 500:
                ...
                print(
                    Fore.WHITE
                    + Back.RED
                    + "  > Too long......... Must be less than 500."
                )
...
class Bot:
    ...
    def handle(self, comand):
        if comand == "add":
            ...
            name = prompt(
                "    > Enter the name of the note you want to delete: ",
                completer=comm_list,
                complete_while_typing=True,
            )
            ...
            comm_list = WordCompleter(self.book.list_names(), ignore_case=True)
            name = prompt(
                "    > Enter the name of the note you want to edit: ",
                completer=comm_list,
                complete_while_typing=True,
            )
            ...
            value = prompt(
                "    > Choose what to look for. Name/Tags/Note: ",
                completer=comm_list,
                complete_while_typing=True,
            ).title()
...
def main():
    ...
    comm_list = WordCompleter(
        ["add", "show", "remove", "edit", "search", "save", "load", "exit"],
        ignore_case=True,
    )
    ...
    while True:
        comand = (
            prompt(
                "    > Your command: ", completer=comm_list, complete_while_typing=True
            )
            .lower()
            .strip()
        )
